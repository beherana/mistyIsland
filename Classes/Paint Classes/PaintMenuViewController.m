...
- (void) redrawMenu {
    ...
    NSString *localName = [Misty_Island_Rescue_iPadAppDelegate getLocalizedAssetName:[NSString stringWithFormat:@"selectapainting"]];
	NSString *imagePath = [bundle pathForResource:localName ofType:@"png"];
