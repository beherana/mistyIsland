...
-(void)initWithParent:(id)parent {
	...
	self.easyimage = [UIImage imageNamed:@"easy_button_unselected_dots.png"];
	self.easyimageSelected = [UIImage imageNamed:@"easy_button_selected_dots.png"];
	self.hardimage = [UIImage imageNamed:@"difficult_unselected_dots.png"];
	self.hardimageSelected = [UIImage imageNamed:@"difficult_selected_dots.png"];
