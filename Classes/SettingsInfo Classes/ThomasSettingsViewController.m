...
@synthesize settingsIPhoneController;
...
- (void)loadView {
    ...
    self.settingsIPhoneController = c;
}

-(void)viewDidAppear:(BOOL)animated {
    [self.settingsIPhoneController viewDidAppear:animated];
}
...
- (void)dealloc {
    [super dealloc];
    self.settingsIPhoneController = nil;
}
